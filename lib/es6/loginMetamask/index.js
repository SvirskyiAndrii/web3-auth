...
export const loginMetamask = ({ publicAddress, signature, history, slug, redirectUrl, API_SIGN_IN_METAMASK, handlers, callback, }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const body = {
        publicAddress,
        signature,

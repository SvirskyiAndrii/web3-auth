...
var web3NeyraAuth = function (_a) {
    var authToken = _a.authToken, refreshToken = _a.refreshToken, history = _a.history, dispatch = _a.dispatch, redirectUrl = _a.redirectUrl, subdomain = _a.subdomain, API_SIGN_IN_METAMASK = _a.API_SIGN_IN_METAMASK, handleMetamaskLogin = _a.handleMetamaskLogin, savePubKey = _a.savePubKey, errorMessages = _a.errorMessages, handleSignUp = _a.handleSignUp, searchParams = _a.searchParams, setSignatureError = _a.setSignatureError, setIsConnecting = _a.setIsConnecting, addNotification = _a.addNotification, REACT_APP_UNSTOPPABLE_CLIENT_ID = _a.REACT_APP_UNSTOPPABLE_CLIENT_ID, API_AUTH = _a.API_AUTH, setToken = _a.setToken, SIGN_IN_ERROR_MESSAGES = _a.SIGN_IN_ERROR_MESSAGES, account = _a.account, wallet = _a.wallet, disconnect = _a.disconnect, connect = _a.connect, signMessage = _a.signMessage;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            console.log('web3NeyraAuth', { authToken: authToken, refreshToken: refreshToken });
            if (wallet) {
                disconnect(wallet);
            }
            else {
                connect().then(function (res) { return __awaiter(void 0, void 0, void 0, function () {
                    var provider_1, label_1, currentAccount_1, sig_1;
                            ...
                            case 1:
                                ...
                                if ((sig_1 && label_1 === 'MetaMask') ||
                                    ...
                                    (0, loginMetamask_1.loginMetamask)({
                                        ...
                                        API_SIGN_IN_METAMASK: API_SIGN_IN_METAMASK,
                                        ...
                                        if (errorMessages.unregistered === error.message) {
                                            if (label_1 === 'MetaMask' ||
                                                ...
                                                handleSignUp(is_coinbase, searchParams, currentAccount_1, provider_1, setSignatureError, dispatch, redirectUrl, setIsConnecting, history);
                                            }
                                            if (sig_1 && label_1 === 'Unstoppable') {
                                                (0, loginUnstoppableEffect_1.loginUnstoppableEffect)({
                                                    history: history,
                                                    redirectUrl: redirectUrl,
                                                    REACT_APP_UNSTOPPABLE_CLIENT_ID: REACT_APP_UNSTOPPABLE_CLIENT_ID,
                                                    API_AUTH: API_AUTH,
                                                    setToken: setToken,
                                                });
                                            }
